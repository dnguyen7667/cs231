...
class TwoLayerNet(object):
    ...
    def predict(self, X):
        ...
        # all we need to do is to repeat steps in loss func to calculate the scores and p

        layer1 = X.dot(W1) + b1  # N,H
        layer1r = np.maximum(layer1, 0.0)
        layer2 = layer1r.dot(W2) + b2

        layer2_norm = layer2 - layer2.max()
       
        
        y_pred = layer2_norm.argmax(axis = 1)
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
